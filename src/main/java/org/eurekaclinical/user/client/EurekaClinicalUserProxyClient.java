...
/**
 * EurekaclinicalUserClient is a client that should be used be external applications
 * 
 * @author miaoai
 */
public class EurekaClinicalUserProxyClient extends EurekaClinicalClient {
