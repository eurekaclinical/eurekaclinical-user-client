...
public abstract class UserRequest implements UserRequestVisitable {
    ...
    public String toString() {
        return "UserRequest{" + "id=" + id + ", username=" + username + ", firstName=" + firstName + ", lastName=" + lastName + ", fullName=" + fullName + ", email=" + email + ", verifyEmail=" + verifyEmail + ", organization=" + organization + ", title=" + title + ", department=" + department + ", loginType=" + loginType + '}';
    }
